...
def perception_step(Rover):
    ...
    Rover.vision_image[:,:,0] = 255*obstacle_threshed*mask
    Rover.vision_image[:,:,1] = 255*rock_threshed
    Rover.vision_image[:,:,2] = 255*navigate_threshed
    ...
    navigate_x_world,navigate_y_world = pix_to_world(navigate_x_rover, navigate_y_rover, Rover.pos[0], Rover.pos[1], Rover.yaw, 200, 10)
    ...
    if Rover.pitch <=0.1 and Rover.roll <= 0.1 :
        Rover.worldmap[navigate_y_world, navigate_x_world,2] += 10
    ...
    Rover.nav_dists, Rover.nav_angles = to_polar_coords(navigate_x_rover, navigate_y_rover)
    Rover.obs_dists, Rover.obs_angles = to_polar_coords(obstacle_x_rover, obstacle_y_rover)
